      ...
      <div className="bg-white shadow-lg rounded-lg w-44 h-50 lg:w-56 lg:h-100">
        ...
        <div className="px-5 pb-5">
          ...
          <div className="flex items-center">
            ...
            <p className="text-sm md:text-base ml-2">4.4 | Terjual 0</p>
          </div>
        </div>
      </div>
    </a>
